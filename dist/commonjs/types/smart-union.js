...
function smartUnion(options) {
    return z.pipe(z.unknown(), z.transform((input, ctx) => {
        ...
        const parentZeroDefaultCtr = (0, default_to_zero_value_js_1.startCountingDefaultToZeroValue)();
        // Filter out invalid options
        for (const [i, option] of options.entries()) {
            const unrecognizedCtr = (0, unrecognized_js_1.startCountingUnrecognized)();
            const zeroDefaultCtr = (0, default_to_zero_value_js_1.startCountingDefaultToZeroValue)();
