...
```bash
npm add https://github.com/mfbx9da4/petstore-sdk-typescript
```

### PNPM

```bash
pnpm add https://github.com/mfbx9da4/petstore-sdk-typescript
```

### Bun

```bash
bun add https://github.com/mfbx9da4/petstore-sdk-typescript
```

### Yarn

```bash
yarn add https://github.com/mfbx9da4/petstore-sdk-typescript
```
